...
```
module "alb_www" {
  source          = "github.com/kalyanburramukku/terraform-modules/aws/loadbalancer/lb-application"
...
module "alb_listner_redirect_www" {
  source               = "github.com/kalyanburramukku/terraform-modules/aws/loadbalancer/lb-application-listner-redirect"
  port                 = "80"
  protocol             = "HTTP"
  redirect_port        = "443"
...
module "alb_listener_www_443" {
  source           = "github.com/kalyanburramukku/terraform-modules/aws/loadbalancer/lb-application-listner"
  alb_arn          = module.alb_www.alb_arn
  alb_lb_port      = "443"
...
module "alb_tg_www_443" {
  source          = "github.com/kalyanburramukku/terraform-modules/aws/loadbalancer/lb-application-target"
  environment     = var.environment
  health_path     = "/"
  health_port     = "8080"
