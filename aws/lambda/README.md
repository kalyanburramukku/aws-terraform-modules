...
module "start_instance" {
  source             = "github.com/kalyanburramukku/terraform-modules/aws/lambda/lambda_function"
...
module "start_instance_permission_cwevents" {
  source               = "github.com/kalyanburramukku/terraform-modules/aws/lambda/lambda_permission"
