...
module "cw_events_target_start" {
  source    = "github.com/kalyanburramukku/terraform-modules/aws/cw_events/cloudwatch_event_target"
...
module "cw_events_rule_start" {
  source              = "github.com/kalyanburramukku/terraform-modules/aws/cw_events/cloudwatch_event_rule"
