...
```
module "ecs_cluster" {
  source      = "github.com/kalyanburramukku/terraform-modules/aws/ecs-cluster"
...
module "www_ecs_service" {
  source              = "github.com/kalyanburramukku/terraform-modules/aws/ecs/ecs-service"
...
module "www_ecs_scale" {
  source                      = "github.com/kalyanburramukku/terraform-modules/aws/ecs/ecs-scale"
...
module "www_ecs_task_definition" {
  source                    = "github.com/kalyanburramukku/terraform-modules/aws/ecs/ecs-task-definition"
  account_id                = var.account_id
  common_tags               = var.tags
  environment               = var.environment
...
```
module "ecr_www" {
  source          = "github.com/kalyanburramukku/terraform-modules/aws/ecs/ecr"
  environment     = var.environment
...
```
module "image_www" {
  source              = "github.com/kalyanburramukku/terraform-modules/aws/ecs/ecr-image"
...
```
module "ecs_cwlg_www" {
  source = "github.com/kalyanburramukku/terraform-modules/aws/cloudwatch/cw-lg"
  environment = var.environment
