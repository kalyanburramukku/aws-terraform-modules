...
```
module "devops" {
  source                        = "github.com/kalyanburramukku/terraform-modules/aws/iam/iam-user-role"
  account_id                    = "123456789"
  assumned_role_policy_template = "assume_role"
  name                          = "kalyanburramukku_iam_role_devops_engineer"
  policy_template_file          = "devops_engineer_custom_policy"
}
module "devops_readonly_attach_policy" {
  source     = "github.com/kalyanburramukku/terraform-modules/aws/iam/iam-attach-policy"
